...
export const ERROR_MESSAGES = {
  ...
  ERROR_WITH_HORSEPOWER: "Введите корректное значение. От 0 до 2500.",
  ERROR_WITH_DISCRIPTION: "Скократите описание автомобиля. Колличетво символов должно быть от 1 до 255",
} as const;
...
export const CHOOSE_MESSAGES = {
  ...
  DESCRIPTION:
    "Введите описание автомобиля: 📝\n\n(не более 255 символов, например 'Автомобиль в хорошем состоянии')",
  PRICE:

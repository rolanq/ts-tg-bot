...
export const MESSAGES = {
  ...
  PHOTOS_LIMIT_REACHED: `Достигнут лимит фотографий (9 штук). Нажмите "Готово 🆗" для просмотра черновика`,
  ...
  CREATING_AD: "Создаем объявление...",
} as const;
...
export const CHOOSE_MESSAGES = {
  ...
  VIDEO: "Отправьте видео автомобиля: 🎥\n\nИли нажмите 'Пропустить 🔄'",
  VIDEO_EDIT:
    "Отправьте видео автомобиля: 🎥\n\nИли нажмите 'Удалить видео 🔄', чтобы удалить видео из объявления",
};
